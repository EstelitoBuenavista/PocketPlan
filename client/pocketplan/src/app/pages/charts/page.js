...
export default function Dashboard() {
  return (
    <div className="background flex flex-col min-h-screen">
      ...
      <div className="md:px-32 sm:px-16 px-4 py-4 overflow-x-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-4">
                ...
                <div className="rounded-xl">
                  <div className="bg-base-100 rounded-xl p-5">
                    <h3 className="text-xl md:text-2xl font-medium mb-4 text-neutral text-center">
                      Category Trends
                    </h3>
                ...
                {/* Right: Daily Expense Chart and Categorized Expenses */}
                <div className="flex flex-col gap-4">
                  <div className="p-5 bg-base-100 rounded-xl">
                    <h3 className="text-xl md:text-2xl font-medium mb-4 text-neutral">Categorized Expenses</h3>
                    <div className="w-full h-[300px] md:h-[400px]">
                      <CategoryMixBarChart selectedAccount={selectedAccount} />
                    </div>
                  </div>
                  <div className="p-5 bg-base-100 rounded-xl">
                    <h3 className="text-xl md:text-2xl font-medium mb-4 text-neutral">Daily Overview</h3>
                    <div className="w-full h-[300px] md:h-[400px]">
